...
def intermediatePointTo(self, lon1, lat1, lon2, lat2, fraction):
    """
    Returns the point at given fraction between ‘self’ point and given point.

    @param   {LatLon} point - Latitude/longitude of destination point.
    @param   {number} fraction - Fraction between the two points (0 = self point, 1 = specified point).
    @returns {LatLon} Intermediate point between self point and destination point.
